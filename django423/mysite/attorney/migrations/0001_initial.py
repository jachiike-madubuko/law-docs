# Generated by Django 2.0 on 2018-05-02 06:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.FloatField(blank=True, db_column='price', default=19.99)),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('legal_ptr',
                 models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                                      primary_key=True, serialize=False, to='attorney.Legal')),
                ('content', models.CharField(blank=True, db_column='content', max_length=500, null=True)),
                ('piecetype', models.CharField(blank=True, db_column='pieceType', max_length=30, null=True)),
                (
                    'attached_doc',
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='attorney.Document')),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.AddField(
            model_name='view',
            name='legal',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='attorney.Legal'),
        ),
        migrations.AddField(
            model_name='view',
            name='person',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='attorney.Person'),
        ),
        migrations.AddField(
            model_name='use',
            name='legal',
