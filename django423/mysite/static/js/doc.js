+function ($) {
    ...
    $("#merge").hide();
    $("#qList li").css({
        "float": "left", "box-shadow": "1px 1px 50px #ddd",
    ...
    //TODO replace with https://jqueryui.com/accordion/#sortable
    $("#sortable").sortable({
        axis: "y",
        revert: false,
        placeholder: "ui-state-highlight",
    });
    //TODO fix with https://jqueryui.com/sortable/#placeholder
    $("ui-state-highlight").addClass("ui-state-defaults");


    $("#sortable").disableSelection();

    //TODO integrate below for merge fields
    // $( "#draggable" ).draggable({
...
//functionality for the add button. Will be generalized for all DPs
    ...
    $("#newDP").on('click', function () {
        var newbie = "<li class='ui-state-defaults'><p class = 'medium'></p><p class = 'italics ui-state-default'> Blank DocPiece </p><p class = 'hard'></p><ol class = 'legaLogi'></ol></li>";
    ...
    $("#testS").on('click', function () {
        var newbie = "<li class='ui-state-defaults'><p class = 'medium'></p><p class = 'italics ui-state-default witdent'>Testator Signature: ________________________________ <br> {Applicant.FullName}&emsp;&emsp;&emsp;&emsp;</p><p class = 'hard'></p><ol class = 'legaLogi'></ol></li>";
        $(".A").parent().parent().after(newbie);
        $('.legaLogi').hide();
        $("#sortable").change(); //updates the doc and adds buttons to new DPs
        $("#addbox").dialog("close");
...
// /your current y position on the page
    ...
    $("#qbox").dialog({
        autoOpen: false,
        //TODO display title DocPiece Library
        position: {
            my: "left center",
            at: "right center",
            of: ".Q",
